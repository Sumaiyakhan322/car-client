...
const Team = () => {
    ...
    <h2  className="mb-12 text-3xl font-bold">
      Meet the <u  className="text-orange-600 dark:text-orange-600-400">team</u>
    </h2>
    ...
    <div  className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
      <div  className="mb-6 lg:mb-0">
        <div
          ...
          <div  className="relative overflow-hidden bg-cover bg-no-repeat">
            <img src={team1}  className="w-full rounded-t-lg" />
            <a href="#!">
            ...
            <ul  className="mx-auto flex list-inside justify-center">
              <a href="#!"  className="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                   className="h-4 w-4 text-orange-600 dark:text-orange-600-400">
                  <path fill="currentColor"
              ...
              <a href="#!"  className="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                   className="h-3.5 w-3.5 text-orange-600 dark:text-orange-600-400">
                  <path fill="currentColor"
      ...
      <div  className="mb-6 lg:mb-0">
        <div
           className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div  className="relative overflow-hidden bg-cover bg-no-repeat">
            <img src={team2}  className="w-full rounded-t-lg" />
            <a href="#!">
              <div  className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"></div>
            </a>
            <svg  className="absolute text-white dark:text-neutral-700  left-0 bottom-0" xmlns="http://www.w3.org/2000/svg"
          ...
          <div  className="p-6">
            ...
            <ul  className="mx-auto flex list-inside justify-center">
              <a href="#!"  className="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg"  className="h-4 w-4 text-orange-600 dark:text-orange-600-400"
      ...
      <div  className="">
        <div
           className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div  className="relative overflow-hidden bg-cover bg-no-repeat">
            <img src={team3} className="w-full rounded-t-lg" />
            <a href="#!">
              <div  className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed"></div>
            </a>
            <svg  className="absolute text-white dark:text-neutral-700 left-0 bottom-0" xmlns="http://www.w3.org/2000/svg"
